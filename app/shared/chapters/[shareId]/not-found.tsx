...
export default function SharedChapterUnavailable() {
  return (
    <StatusPage
      ...
      description="The journey may be private, its sharing link may have been revoked, or the address may be incomplete. We keep those possibilities indistinguishable to protect the author’s privacy."
      primaryHref="/"
